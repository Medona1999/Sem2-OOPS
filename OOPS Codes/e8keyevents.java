...
public class e8keyevents extends Applet implements KeyListener 
{ 
        ...
        public void keyReleased(KeyEvent e) 
                ...
                charString="Key character='"+c+"'";               keyCodeString="keycode="+keyCode+"("+KeyEvent.getKeyText(keyCode)+")";                
...
keyCodeString="keycode="+keyCode+"("+KeyEvent.getKeyText(keyCode)+")"; 
